                  ...
                  child: Container(
                    ...
                    child: Row(spacing: Dimensions.paddingSizeExtraSmall, children: [
                      ...
                      Expanded(
                        child: Container(
                          height: 2,
                          color: authController.storeStatus == 0.6 ? Theme.of(context).primaryColor.withValues(alpha: 0.5) : authController.storeStatus == 0.9 ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withValues(alpha: 0.5),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Container(
                          height: 2,
                          color: authController.storeStatus == 0.9 ? Theme.of(context).primaryColor.withValues(alpha: 0.5) : Theme.of(context).disabledColor.withValues(alpha: 0.5),
                        ),
                      ),
                    ]),
                  ),
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Text('insert_language_wise_restaurant_name'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
